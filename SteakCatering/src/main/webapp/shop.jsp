		...
		<div id="table-div">
			<div class="table-pic table-show clearfix">
				<a href="shop-con.jsp" class="shop-wrap shop-right">
					<span class="shop-pic">
						<img src="${pageContext.request.contextPath}/img/shop-pic1.jpg" alt="" />
					</span>
					<p class="shop-tit">北京朝阳区店</p>
				</a>
				<a href="shop-con.jsp" class="shop-wrap shop-right">
					<span class="shop-pic">
						<img src="${pageContext.request.contextPath}/img/shop-pic2.jpg" alt="" />
					</span>
					<p class="shop-tit">北京朝阳区店</p>
				</a>
				<a href="shop-con.jsp" class="shop-wrap">
					<span class="shop-pic">
						<img src="${pageContext.request.contextPath}/img/shop-pic3.jpg" alt="" />
					</span>
					<p class="shop-tit">北京朝阳区店</p>
				</a>
				<a href="shop-con.jsp" class="shop-wrap shop-right">
					<span class="shop-pic">
						<img src="${pageContext.request.contextPath}/img/shop-pic4.jpg" alt="" />
					</span>
					<p class="shop-tit">北京朝阳区店</p>
				</a>
				<a href="shop-con.jsp" class="shop-wrap shop-right">
					<span class="shop-pic">
						<img src="${pageContext.request.contextPath}/img/shop-pic5.jpg" alt="" />
					</span>
					<p class="shop-tit">北京朝阳区店</p>
				</a>
				<a href="shop-con.jsp" class="shop-wrap">
					<span class="shop-pic">
						<img src="${pageContext.request.contextPath}/img/shop-pic6.jpg" alt="" />
					</span>
					<p class="shop-tit">北京朝阳区店</p>
				</a>
			</div>
